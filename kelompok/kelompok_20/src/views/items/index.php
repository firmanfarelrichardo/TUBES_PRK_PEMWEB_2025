...
<div class="min-h-screen bg-gradient-to-br from-slate-50 via-cyan-50/30 to-slate-50 dark:from-slate-900 dark:via-slate-900 dark:to-slate-900 py-8">
    <div class="container mx-auto px-4">
        ...
        <div class="mb-8">
            ...
            <!-- Filters Section -->
            <div class="bg-white/60 dark:bg-slate-800/60 backdrop-blur-md rounded-2xl p-6 shadow-xl border border-white/20 dark:border-slate-700/50">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        ...
                        <div class="lg:col-span-2">
                            ...
                            <input 
                                ...
                                class="w-full px-4 py-2.5 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-600 rounded-xl text-slate-900 dark:text-white placeholder-slate-400 focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all"
                            >
                        </div>
                        ...
                        <div>
                            ...
                            <select 
                                name="type"
                                class="w-full px-4 py-2.5 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-600 rounded-xl text-slate-900 dark:text-white focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all"
                            >
                        ...
                        <div class="lg:col-span-2 flex gap-3">
                            <button 
                                type="submit"
                                class="flex-1 px-6 py-2.5 bg-gradient-to-r from-primary-600 to-cyan-600 hover:from-primary-700 hover:to-cyan-700 text-white font-bold rounded-xl shadow-lg shadow-primary-500/30 transition-all duration-300 hover:scale-105 flex items-center justify-center gap-2"
                            >
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <a 
                                ...
                                class="px-6 py-2.5 bg-slate-200 dark:bg-slate-700 text-slate-700 dark:text-slate-300 font-bold rounded-xl hover:bg-slate-300 dark:hover:bg-slate-600 transition-all flex items-center justify-center gap-2"
                            >
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <?php if (empty($items)): ?>
            <div class="text-center py-20">
                ...
                <h3 class="text-2xl font-bold text-slate-900 dark:text-white mb-2">Tidak ada laporan ditemukan</h3>
        ...
        <?php else: ?>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mb-8">
                <?php foreach ($items as $item): ?>
                    <a 
                        ...
                        class="group bg-white/80 dark:bg-slate-800/80 backdrop-blur-md rounded-2xl shadow-lg hover:shadow-2xl border border-white/20 dark:border-slate-700/50 overflow-hidden transition-all duration-300 hover:scale-105"
                    >
                        <!-- Image -->
                        <div class="aspect-square bg-gradient-to-br from-slate-100 to-slate-200 dark:from-slate-700 dark:to-slate-800 relative overflow-hidden">
                            ...
                            <div class="absolute top-3 left-3">
                                <?php if ($item['type'] === 'lost'): ?>
                                    <span class="px-3 py-1 bg-rose-500 text-white text-xs font-bold rounded-full shadow-lg">
                                        Kehilangan
                                    </span>
                                <?php else: ?>
                                    <span class="px-3 py-1 bg-teal-500 text-white text-xs font-bold rounded-full shadow-lg">
                                        Ditemukan
                                    </span>
                                <?php endif; ?>
                            </div>
                            ...
                            <?php if (!empty($item['is_safe_claim'])): ?>
                                <div class="absolute bottom-3 right-3">
                                    <span class="px-3 py-1 bg-purple-500 text-white text-xs font-bold rounded-full shadow-lg flex items-center gap-1">
            ...
            <?php if ($pagination['total_pages'] > 1): ?>
                <div class="flex flex-col sm:flex-row items-center justify-between gap-4 bg-white/60 dark:bg-slate-800/60 backdrop-blur-md rounded-2xl p-6 shadow-xl border border-white/20 dark:border-slate-700/50">
                    <p class="text-sm text-slate-600 dark:text-slate-400">
                        Halaman <span class="font-bold text-slate-900 dark:text-white"><?= $pagination['current_page'] ?></span> dari <span class="font-bold text-slate-900 dark:text-white"><?= $pagination['total_pages'] ?></span>
                    </p>
                    ...
                    <div class="flex gap-2">
                        ...
                        ?>
                            <a 
                                ...
                                class="px-4 py-2 font-semibold rounded-lg transition-all <?= $i === $pagination['current_page'] ? 'bg-gradient-to-r from-primary-600 to-cyan-600 text-white shadow-lg shadow-primary-500/30' : 'bg-slate-200 dark:bg-slate-700 text-slate-700 dark:text-slate-300 hover:bg-slate-300 dark:hover:bg-slate-600' ?>"
                            >
                                <?= $i ?>
                            </a>
                        <?php endfor; ?>
